			...
			<div class="row">
				...
				<div class="col-sm-9 col-md-9 padding-right">
					<div class="features_items"><!--features_items-->
						...
						<?php endif; ?>
						<div id="load-ajax">
							<?php $__currentLoopData = $product4; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						...
						<?php if(count($product4)>0): ?>
							<?php $__currentLoopData = $product4->take(1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<input type="hidden" name="idBrand" value="<?php echo e($prod->brand->id); ?>">
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						<?php endif; ?>
						<div class="col-sm-12 col-md-12 text-center">
							<?php echo e($product4->render()); ?>
