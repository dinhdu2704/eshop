            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        ...
                        <form action="admin/comment-product/edit/<?php echo e($comPro->id); ?>" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <?php $__currentLoopData = $product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option  value="<?php echo $pro->id; ?>"
                                        <?php if($comPro->idPro==$pro->id): ?>
                                            <?php echo e("selected"); ?>

                                        <?php endif; ?>

                                    ><?php echo $pro->ten; ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="form-group">
                                <label>Comment</label>
                                <textarea id="demo" class="form-control ckeditor" name="NoiDung"><?php echo e($comPro->noidung); ?></textarea>
                            </div>
