				...
				<div class="row">
					...
					<div class="col-sm-2 col-md-2">
						<div class="single-widget">
							<h2><?php echo e($foo->ten); ?></h2>
							<?php if(count($foo->subFooter)>0): ?>
								<ul class="nav nav-pills nav-stacked">
									<?php $__currentLoopData = $foo->subFooter; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subfoo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<li><a href="<?php echo e($subfoo->tenkodau); ?>"><?php echo e($subfoo->ten); ?></a></li>
