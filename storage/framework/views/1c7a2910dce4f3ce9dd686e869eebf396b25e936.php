                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Footer
                            <small>Đang sửa: <?php echo $footer->ten; ?></small>
                        </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                    ...
                    <?php endif; ?>
                        ...
                        <form action="admin/footer/edit/<?php echo e($footer->id); ?>" method="POST">
                            
                            <div class="form-group">
                                <label>Footer</label>
                                <input class="form-control" name="Ten" placeholder="Điền tên footer category" value="<?php echo $footer->ten; ?>"/>
                            </div>
